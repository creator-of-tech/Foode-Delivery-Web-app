...
export default function Restcard({restInfo}){
    return(
        ...
        <div className="max-w-70 mb-2 transform transition duration-200 hover:scale-95">
            <img className="w-70 h-45 object-cover rounded-2xl border-2" src={"https://media-assets.swiggy.com/swiggy/image/upload/"+restInfo.info.cloudinaryImageId}></img>
            ...
            <div className="flex  items-center gap-2">
             <svg
              ...
              <span className="text-xl">{restInfo?.info?.avgRating}</span>
              <span className="text-xl font-semibold">{restInfo?.info?.sla?.slaString}</span>
            </div>
